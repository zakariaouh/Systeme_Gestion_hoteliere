 ...
 * res_client_x.java
 *
 * Created on Dec 25, 2011, 9:50:28 PM
 */
/**
 *
 * @author user
 */
public class res_client_x extends javax.swing.JFrame {

    /** Creates new form res_client_x */
    public res_client_x() {
        initComponents();
    }
...
REQUETE_SQL.connexionbase();
    ...
    tous_res vv =new tous_res();
     ...
     ArrayList<tabe_reservation> h=REQUETE_SQL.info_Reservation(REQUETE_SQL. Id_Client(cin.getText()));
tabe_reservation a;

DefaultTableModel md=new DefaultTableModel();
md.setColumnIdentifiers(new String[]{"Categorie","Nombre de chambres","Date de reservation","Date de depart","Numero de reservation","Numero client"});
for(int i=0;i<h.size();i++){
    a=h.get(i);
     
  
md.addRow(new Object[]{a.categorie_chambre,a.nbr_chambre,a.date_reservation,a.date_depart,a.id_reservation,a.cin});
}
vv.jTable1.setModel(md);    
...
this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(res_client_x.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new res_client_x().setVisible(true);
            }
        });
    }
